...
### 方式一：使用可执行文件（推荐，无需Python）

1. 从 [Releases](https://github.com/GhUserLiu/md2doc/releases) 下载 `md2doc.exe`
...
| **标题字体** | 文档标题(#): 方正小标宋简体，2号 (22pt)<br>一级标题(##): 黑体，3号 (16pt)<br>二级标题(###): 楷体，3号 (16pt)<br>三级标题(####): 仿宋_GB2312，3号 (16pt) |
| **正文行距** | 固定值 30.5pt |
| **首行缩进** | 2字符 |
| **段前/段后间距** | 0pt（不额外空行） |
| **页边距** | 上3.7cm、下3.7cm、左2.8cm、右2.8cm |
